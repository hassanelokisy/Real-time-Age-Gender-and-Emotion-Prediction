...
emotion_model_path = 'models/emotion_detection_model_50epochs.h5'
age_model_path = 'models/age_model_50epochs.h5'
gender_model_path = 'models/gender_model_50epochs.h5'
